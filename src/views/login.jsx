                        ...
                        <div className="card-body p-0">
                            <div className="row">
                                <div className="col-lg-6 d-none d-lg-block">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlSpace="preserve" width="400px"
                                         height="600px" version="1.1"
                                         style={{
                                ...
                                <div className="col-lg-6" style={{marginTop:124}}>
                                    <div className="p-5">
                                        <div className="text-center">
                                            <h1 className="h4 text-gray-700 mb-4 font-weight-bold">Xoş gəlmisiniz!</h1>
                                        </div>
                                        <form className="user" onSubmit={login}>
                                            <div className="form-group">
                                                <input type="text" className="form-control form-control-user"
                                                       placeholder="E-mail" onChange={e => {
                                                    setFormData(prev => ({
                                                        ...prev,
                                            ...
                                            <button className="btn btn-dark btn-user btn-block font-weight-bold">
                                                Daxil ol
                                            </button>
                                        </form>
                                    </div>
